...
class ShipmentReport(Base):
    ...
    unlinked_reason: Mapped[str] = mapped_column(String(200), default="", server_default="")
    note: Mapped[str] = mapped_column(Text, default="")
...
class WaybillRecord(Base):
    ...
    courier: Mapped[str] = mapped_column(String(30), default="中通", server_default="中通", index=True)
